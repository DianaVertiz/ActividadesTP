...
void systemInit(void)
{
	...
	Chip_SCU_PinMux(PORT_PIN_KEY1, PIN_KEY1, MD_PUP|MD_EZI|MD_ZI, FUNC0);
	Chip_SCU_PinMux(PORT_PIN_KEY2, PIN_KEY2, MD_PUP|MD_EZI|MD_ZI, FUNC0);
	Chip_SCU_PinMux(PORT_PIN_KEY3, PIN_KEY3, MD_PUP|MD_EZI|MD_ZI, FUNC0);
	Chip_SCU_PinMux(PORT_PIN_KEY4, PIN_KEY4, MD_PUP|MD_EZI|MD_ZI, FUNC0);
