...
extern void contadorIface_raise_keyPress1(Contador* handle);

/*! Raises the in event 'keyPress2' that is defined in the default interface scope. */ 
extern void contadorIface_raise_keyPress2(Contador* handle);

/*! Raises the in event 'keyPress4' that is defined in the default interface scope. */ 
extern void contadorIface_raise_keyPress4(Contador* handle);
