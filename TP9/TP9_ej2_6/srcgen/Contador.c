...
static void contador_enact_main_region_decode(Contador* handle);
...
static void contador_enseq_main_region_decode_default(Contador* handle);
...
static void contador_exseq_main_region_decode(Contador* handle);
...
static void contador_react_main_region_decode(Contador* handle);
...
void contador_runCycle(Contador* handle)
{
	...
	for (handle->stateConfVectorPosition = 0;
		...
		case Contador_main_region_decode :
		{
			contador_react_main_region_decode(handle);
			break;
		}
		default:
			break;
...
sc_boolean contador_isStateActive(const Contador* handle, ContadorStates state)
{
	...
	switch (state)
	{
		...
		case Contador_main_region_lockToggle :
			...
			break;
		case Contador_main_region_decode :
			result = (sc_boolean) (handle->stateConfVector[0] == Contador_main_region_decode
			);
			break;
		default:
			result = bool_false;
...
static sc_boolean contador_check_main_region_Increment_tr0_tr0(const Contador* handle)
{
	return (handle->internal.aux == 1) ? bool_true : bool_false;
}
...
static sc_boolean contador_check_main_region_lockToggle_tr0_tr0(const Contador* handle)
{
	return (handle->internal.aux == 2) ? bool_true : bool_false;
}

static sc_boolean contador_check_main_region_decode_tr0_tr0(const Contador* handle)
{
	return (handle->internal.aux == 1 && handle->internal.locked == 0) ? bool_true : bool_false;
}
...
static void contador_effect_main_region_wait_tr0(Contador* handle)
{
	...
	contador_enseq_main_region_decode_default(handle);
}
...
{
	/* Entry action for state 'decode'. */
	handle->internal.aux = contadorIface_getKeyPressed(handle);
}
...
{
	/* 'default' enter sequence for state wait */
	contador_enact_main_region_wait(handle);
...
{
	/* 'default' enter sequence for state decode */
	contador_enact_main_region_decode(handle);
	handle->stateConfVector[0] = Contador_main_region_decode;
	handle->stateConfVectorPosition = 0;
}
...
{
	/* The reactions of state Increment. */
	if (contador_check_main_region_Increment_tr0_tr0(handle) == bool_true)
	{ 
...
{
	/* The reactions of state rstCnt. */
	if (contador_check_main_region_rstCnt_tr0_tr0(handle) == bool_true)
	{ 
...
{
	/* The reactions of state lockToggle. */
	if (contador_check_main_region_lockToggle_tr0_tr0(handle) == bool_true)
	{ 
...
{
	/* The reactions of state decode. */
	if (contador_check_main_region_decode_tr0_tr0(handle) == bool_true)
	{ 
		contador_effect_main_region_decode_tr0(handle);
	}  else
	{
		if (contador_check_main_region_decode_tr1_tr1(handle) == bool_true)
		{ 
			contador_effect_main_region_decode_tr1(handle);
		}  else
		{
