...
#ifndef CERRADURAREQUIRED_H_
#define CERRADURAREQUIRED_H_
...
This is a state machine uses time events which require access to a timing service. Thus the function prototypes:
	- cerradura_setTimer and
	- cerradura_unsetTimer
are defined.
...
*/
extern void cerradura_setTimer(Cerradura* handle, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic);
...
/*! 
	...
	\param evid An unique identifier of the event.
*/
extern void cerradura_unsetTimer(Cerradura* handle, const sc_eventid evid);
