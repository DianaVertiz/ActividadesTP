...
typedef enum
{
	LedOnOff_main_region_LeftRight,
	LedOnOff_main_region_LeftRight_r1_led0,
	LedOnOff_main_region_LeftRight_r1_led1,
	LedOnOff_main_region_LeftRight_r1_led2,
	LedOnOff_main_region_LeftRight_r1_led3,
	LedOnOff_main_region_RightLeft,
	LedOnOff_main_region_RightLeft_r1_led0,
	LedOnOff_main_region_RightLeft_r1_led1,
	LedOnOff_main_region_RightLeft_r1_led2,
	LedOnOff_main_region_RightLeft_r1_led3,
	LedOnOff_last_state
} LedOnOffStates;
...
typedef struct
{
	sc_boolean ledOnOff_main_region_LeftRight_r1_led0_tev0_raised;
	sc_boolean ledOnOff_main_region_LeftRight_r1_led1_tev0_raised;
	sc_boolean ledOnOff_main_region_LeftRight_r1_led2_tev0_raised;
	sc_boolean ledOnOff_main_region_LeftRight_r1_led3_tev0_raised;
	sc_boolean ledOnOff_main_region_RightLeft_r1_led0_tev0_raised;
	sc_boolean ledOnOff_main_region_RightLeft_r1_led1_tev0_raised;
	sc_boolean ledOnOff_main_region_RightLeft_r1_led2_tev0_raised;
	sc_boolean ledOnOff_main_region_RightLeft_r1_led3_tev0_raised;
} LedOnOffTimeEvents;
