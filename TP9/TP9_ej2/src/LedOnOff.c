...
static void ledOnOff_exact_main_region_led0(LedOnOff* handle);
...
static void ledOnOff_clearInEvents(LedOnOff* handle)
{
	...
	handle->timeEvents.ledOnOff_main_region_led0_tev0_raised = bool_false;
}
...
static sc_boolean ledOnOff_check_main_region_led0_tr0_tr0(const LedOnOff* handle)
{
	return handle->timeEvents.ledOnOff_main_region_led0_tev0_raised;
}
...
{
	/* Entry action for state 'led0'. */
	ledOnOff_setTimer(handle, (sc_eventid) &(handle->timeEvents.ledOnOff_main_region_led0_tev0_raised) , 1000, bool_false);
...
{
	/* Exit action for state 'led0'. */
	ledOnOff_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.ledOnOff_main_region_led0_tev0_raised) );		
}
...
static void ledOnOff_exseq_main_region_led0(LedOnOff* handle)
{
	...
	handle->stateConfVectorPosition = 0;
	ledOnOff_exact_main_region_led0(handle);
}
